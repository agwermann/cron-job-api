...
import (
	...
	batchv1 "github.com/agwermann/kubebuilder-cronjob/api/v1"
	"github.com/agwermann/kubebuilder-cronjob/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "80807133.github.com/agwermann/kubebuilder-cronjob",
